...
namespace ControleVendas.Controllers
{
    public class NivelAcessosController : Controller
    {
        ...
        public NivelAcessosController(ControleVendasDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NivelAcessoID,Nivel")] NivelAcesso nivelAcesso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NivelAcessoID,Nivel")] NivelAcesso nivelAcesso)
        {
